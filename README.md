...
> **Important**
> To see the examples in action you can just click on the Live Demo icon ![](./assets/icon-wp.svg) from the [List of examples](#list-of-examples) table below) for the example you're interested in.
