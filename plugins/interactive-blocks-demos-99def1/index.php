 ...
 * @link      https://github.com/wptrainingteam/interactive-blocks-demos/
 *
...
add_filter( 'render_block_block-development-examples/counter-jquery-99def1', function( $content ) {
	wp_enqueue_script( 'jquery' );
    return $content;
});

add_filter( 'render_block_block-development-examples/counter-alpine-99def1', function( $content ) {
