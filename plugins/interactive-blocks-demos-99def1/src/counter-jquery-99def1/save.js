...
const Save = ( { attributes } ) => {
	return (
		<div { ...useBlockProps.save() }>
			...
			<input width="5" step={ attributes.increment } type="number" className="wp-block-block-development-examples-counter-jquery-99def1__value" value={ attributes.initial } />
