...
<details>
  <summary><em>If you have a local WordPress installation already running, you can clone the repo inside the `plugins` folder of that installation and check the example there</em></summary>
<br>  
